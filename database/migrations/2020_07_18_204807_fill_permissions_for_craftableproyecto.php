...
class FillPermissionsForCraftableproyecto extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCraftableproyecto constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.craftableproyecto',
            'admin.craftableproyecto.index',
            'admin.craftableproyecto.create',
            'admin.craftableproyecto.show',
            'admin.craftableproyecto.edit',
            'admin.craftableproyecto.delete',
            'admin.craftableproyecto.bulk-delete',
        ]);
